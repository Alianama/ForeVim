...
Ubah nilai-nilai berikut sesuai dengan kebutuhan server Anda:
```ini
# 1. Konfigurasi kredensial PostgreSQL kontainer Anda
POSTGRES_USER=forevim
...
# Karena frontend & backend disatukan di port yang sama, masukkan port akses web Anda (port 80)
